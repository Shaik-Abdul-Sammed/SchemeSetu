...
const schemesData = [
  {
    ...
    name: "NSFDC Micro Finance Scheme (MSY / Micro-Credit)",
    shortName: "NSFDC-MFS",
    officialMinistry: "Ministry of Social Justice and Empowerment, Government of India",
    department: "National Scheduled Castes Finance and Development Corporation (NSFDC)",
    level: "Central",
    state: "Pan-India",
    category: "Concessional Micro Finance Loan",
    targetBeneficiaries: "Scheduled Caste (SC) individuals with annual family income up to ₹5.00 Lakhs",
    beneficiary: "SC Micro Entrepreneurs & Self Help Groups",
    minAge: 18,
    maxAge: 65,
    minIncome: 0,
    maxIncome: 500000,
    gender: "All",
    casteEligibility: ["SC"],
    occupation: "Micro Entrepreneur / Vendor / Artisan",
    sector: "Micro Projects & Income Generating Activities",
    eligibleSectors: ["Micro-Trade", "Small Shop", "Artisan", "Handicrafts", "Livestock"],
    minLoan: 10000,
    maxLoan: 140000,
    maxProjectCost: 155555,
    subsidyPercentage: 0,
    ...
    creditGuaranteeCover: "Routed via Channel Partners (SCAs, PSBs, RRBs, NBFC-MFIs)",
    summary: "Tailored concessional micro-credit up to ₹1.40 Lakh covering up to 90% of project cost at 6.5% interest rate for SC beneficiaries with family income up to ₹5.00 Lakhs.",
    benefits: "Covers up to 90% project cost (up to ₹1.40 Lakh) with 6.5% concessional interest and 3 months moratorium period.",
    detailedBenefits: [
      "Maximum loan amount up to ₹1.40 Lakh per unit/beneficiary.",
      "Concessional interest rate of 6.5% p.a. (5.0% for female SC entrepreneurs under Mahila Samriddhi Yojana).",
      "NSFDC finances up to 90% of the total project cost.",
      "Routed seamlessly through 100+ authorized Channel Partners (SCAs, PSBs, RRBs, NBFC-MFIs)."
    ],
    eligibilityCriteria: [
      "Applicant must belong to the Scheduled Caste (SC) community.",
      "Annual family income must not exceed ₹5.00 Lakhs per annum.",
      "Applicant should possess necessary skill or experience for the proposed micro project."
    ],
    documentsRequired: [
      "Caste Certificate (SC Certificate issued by Competent Authority)",
      "Income Certificate (Showing annual family income <= ₹5.00 Lakhs)",
      "Aadhaar Card / Voter ID (Identity & Address Proof)",
      "Project Cost Estimate / Quotation",
      "Bank Account Details (Aadhaar Seeded for DBT)"
    ],
    officialSourceUrl: "https://nsfdc.nic.in",
    officialApplicationPortal: "https://nsfdc.nic.in/en/micro-credit-scheme",
  ...
  },
  {
    ...
    level: "Central",
    state: "Pan-India",
    category: "Concessional Term Loan",
    targetBeneficiaries: "Scheduled Caste (SC) entrepreneurs with annual family income up to ₹5.00 Lakhs",
    beneficiary: "SC Business & Industrial Entrepreneurs",
    minAge: 18,
    maxAge: 65,
    minIncome: 0,
    maxIncome: 500000,
    ...
    casteEligibility: ["SC"],
    occupation: "Business",
    sector: "Commercial, Industrial & Agro-Processing Projects",
    eligibleSectors: ["Manufacturing", "Transport", "Services", "Trade", "Agro-Processing"],
    minLoan: 140001,
    maxLoan: 5000000,
    maxProjectCost: 5555555,
    subsidyPercentage: 0,
    scSubsidyPercentage: 0,
    grantAmount: 0,
    interestRate: 7.5,
    ...
    fundingCoveragePct: 90,
    collateralRequired: false,
    creditGuaranteeCover: "CGTMSE / Channel Partner Guarantee",
    summary: "Concessional term loans up to ₹50.00 Lakhs for viable commercial and industrial projects by SC entrepreneurs covering up to 90% of project cost at 7.5% interest rate.",
    benefits: "Loans up to ₹50.00 Lakhs with 90% project cost funding, low 6.5%-8.0% interest rate, and 6-12 months moratorium period.",
    detailedBenefits: [
      "Term loan assistance up to ₹50.00 Lakhs for projects in manufacturing, service, or trading sectors.",
      "Concessional interest rate between 6.5% and 8.0% p.a.",
      "NSFDC provides up to 90% of the project cost as concessional loan assistance.",
      "Flexible repayment tenure up to 5-10 years with 6 to 12 months moratorium on principal repayment."
    ],
    eligibilityCriteria: [
      "Applicant must belong to Scheduled Caste (SC) community.",
      "Annual family income limit up to ₹5.00 Lakhs per annum.",
      "Project must be commercially viable and non-polluting."
    ],
    documentsRequired: [
      "Caste Certificate (SC Certificate)",
      "Income Certificate (Family income <= ₹5.00 Lakhs)",
      "Detailed Project Report (DPR) / Machinery Quotations",
      "Aadhaar Card & PAN Card",
      "Land / Premises Agreement or Ownership Document"
    ],
    officialSourceUrl: "https://nsfdc.nic.in",
    officialApplicationPortal: "https://nsfdc.nic.in/en/term-loan-scheme",
    lastVerifiedDate: "2026-09-06",
    dataStatus: "VERIFIED"
  },
  {
    id: "nsfdc-educational-loan",
    name: "NSFDC Concessional Educational Loan Scheme for SC Students",
    shortName: "NSFDC-ELS",
    officialMinistry: "Ministry of Social Justice and Empowerment, Government of India",
    department: "National Scheduled Castes Finance and Development Corporation (NSFDC)",
    level: "Central",
    state: "Pan-India",
    category: "Concessional Education Loan",
    targetBeneficiaries: "Scheduled Caste (SC) students pursuing professional/higher education in India & Abroad",
    beneficiary: "SC Students & Research Scholars",
    minAge: 17,
    maxAge: 35,
    minIncome: 0,
    maxIncome: 500000,
    ...
    eligibleSectors: ["Engineering", "Medicine", "Management", "Ph.D", "Technical Courses"],
    minLoan: 50000,
    maxLoan: 3000000,
    maxLoanIndia: 2000000,
    maxLoanAbroad: 3000000,
    maxProjectCost: 3333333,
    subsidyPercentage: 0,
    scSubsidyPercentage: 0,
    grantAmount: 0,
    interestRate: 6.5,
    ...
    fundingCoveragePct: 90,
    collateralRequired: false,
    creditGuaranteeCover: "Credit Guarantee Fund Scheme for Educational Loans (CGFEL)",
    summary: "Concessional educational loans up to ₹20 Lakhs for studies in India and ₹30 Lakhs for studies abroad covering up to 90% of course fee at 4.0%-6.5% interest rate.",
    benefits: "Covers tuition, living expenses, and books up to 90% of cost at highly concessional 4%-6.5% interest with moratorium until course completion + 12 months.",
    detailedBenefits: [
      "Loan amount up to ₹20 Lakhs for professional courses in India and up to ₹30 Lakhs for studies Abroad.",
      "Concessional interest rate of 6.5% p.a. (rebate of 0.5% - 2.5% for SC female students bringing interest to 4.0%).",
      "Covers up to 90% of tuition fees, admission fee, hostel charges, books, and equipment.",
      "Moratorium period: Course duration plus 6 to 12 months before EMI repayment starts."
    ],
    eligibilityCriteria: [
      "Student must belong to Scheduled Caste (SC) community.",
      "Annual family income must not exceed ₹5.00 Lakhs per annum.",
      "Must have secured admission to professional/technical course in recognized institution in India or Abroad."
    ],
    documentsRequired: [
      "SC Caste Certificate",
      "Income Certificate (Family Income <= ₹5.00 Lakhs)",
      "Admission Offer Letter / Fee Structure from Institution",
      "Marksheets of X, XII & Qualifying Degree",
      "Aadhaar Card & PAN Card of Student and Co-borrower (Parent)"
    ],
    officialSourceUrl: "https://nsfdc.nic.in",
    officialApplicationPortal: "https://nsfdc.nic.in/en/education-loan-scheme",
    lastVerifiedDate: "2026-09-06",
    dataStatus: "VERIFIED"
  },
  {
