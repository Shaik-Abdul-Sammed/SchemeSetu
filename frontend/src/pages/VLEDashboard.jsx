    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto' }} className="container py-8">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <h1 style={{ fontSize: '1.75rem', color: '#0B192C', margin: '0.25rem 0 0' }}>VLE Agent Incentives & Portal</h1>
          <p style={{ color: '#64748B', fontSize: '0.95rem', margin: 0 }}>
            Center: {vle.centerName} ({vle.name})
          </p>
        </div>

        <button className="btn btn-green btn-sm">+ Register New Citizen Intake</button>
      </div>

      {/* Analytics Metric Cards */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
        <div className="card" style={{ background: '#F8FAFC' }}>
          <div style={{ fontSize: '0.85rem', color: '#64748B' }}>Total Applications Filed</div>
        ...
        <div className="card" style={{ background: '#ECFDF5' }}>
          <div style={{ fontSize: '0.85rem', color: '#047857' }}>Approved Loans</div>
          <div style={{ fontSize: '1.8rem', fontWeight: 800, color: '#059669' }}>{vle.approvedApplications}</div>
        </div>

        <div className="card" style={{ background: '#FEF3C7' }}>
          <div style={{ fontSize: '0.85rem', color: '#92400E' }}>VLE Commission Earned</div>
      ...
      {/* Registrations List */}
      <div className="card">
        <h3 style={{ fontSize: '1.2rem', color: '#0B192C', marginBottom: '1rem' }}>Recent Citizen Submissions</h3>
